...
REM
REM For a working pipeline on Windows, use bin\run_simple.bat instead:
REM   bin\run_simple.bat examples\simple_test.c
REM   bin\run_simple.bat llvm\test\sample.c
REM
...
echo.
echo Redirecting to bin\run_simple.bat for the working Python-based pipeline...
echo.

if "%~1"=="" (
    echo Usage: bin\run_energy.bat path\to\your\file.c
    echo.
    echo Example: bin\run_energy.bat examples\simple_test.c
    echo          bin\run_energy.bat llvm\test\sample.c
    echo.
    goto :end
)
